...
Коммит с компактностью событий, окончаниями слова «файл» и геометрией рядов имеет сообщение:
...
## Проверка кастомного курсора

- [ ] На десктопе в самой книге отображается оранжевый карандаш.
- [ ] Активная точка находится на кончике грифеля; hotspot — `2 30`.
- [ ] Над кнопками, полароидами и навигацией курсор остаётся карандашом.
- [ ] В Memory Studio остаётся системный курсор для точного drag-and-drop и таймлайна.
